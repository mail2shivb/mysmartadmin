...
/// Vault Explorer — returns content only.
  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: [
        ...
        Row(
          children: [
            const Expanded(child: SectionTitle('Documents')),
            TextButton(
              onPressed: () => context.go(AppRouter.documents),
              child: const Text(
                'See all',
                style: TextStyle(color: AppColors.royalPurple, fontSize: 13),
              ),
            ),
          ],
        ),
        ...
        Container(
          ...
          child: const Row(
            children: [
              Icon(Icons.lock_outline, color: AppColors.royalPurple, size: 16),
              SizedBox(width: 8),
              Expanded(
                child: Text(
