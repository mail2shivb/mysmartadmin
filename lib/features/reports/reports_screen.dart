...
/// Reports screen — returns content only.
                ...
                children: [
                  ...
                  Row(
                    children: [
                      _MiniStat(
                        label: 'Bills',
                        value: '£${(bills / 100).toStringAsFixed(2)}',
                        color: AppColors.warning,
                      ),
                      const SizedBox(width: 12),
                      _MiniStat(
                        label: 'Subscriptions',
                        value: '£${(subs / 100).toStringAsFixed(2)}',
                        color: AppColors.info,
                      ),
                    ],
                  ),
          ...
          child: Column(
            children: [
              ListRow(
                ...
                onTap: () => context.push(AppRouter.reportDetail),
              ),
              ...
              ListRow(
                ...
                onTap: () => context.push(AppRouter.lifeTimeline),
              ),
            ],
          ),
        ),
